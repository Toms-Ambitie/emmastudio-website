...
export const MODULES: Record<string, ModuleData> = {
  ...
  ziet:{
    ...
    does:{
      ...
      feats:[
        ...
        { tag:'Wekelijkse monitoring', h:'Emma let op, ook als jij dat niet doet.',
          ...
          vig:'ziet_concurrent' },
        { tag:'Prijsvergelijking', h:'Zie wat zij vragen voor wat jij doet.',
          p:'Emma leest de prijzen van je concurrenten van hun eigen website en zet ze naast jouw diensten. Per behandeling, niet als een gemiddelde waar je niets mee kunt.',
          list:['Prijzen per dienst naast die van jou','Emma koppelt vergelijkbare behandelingen','Klopt de koppeling niet, dan zet je hem zelf recht'],
          vig:'ziet_concurrent' },
        { tag:'Reviews-analyse', h:'Niet het cijfer, maar waar het over gaat.',
          p:'Een 4,6 zegt weinig. Emma leest de reviews van je concurrenten en haalt eruit waar mensen het steeds over hebben: wachttijd, prijs, sfeer, resultaat.',
          list:['Terugkerende themas per concurrent','Wat klanten er goed en minder goed aan vinden','Alleen openbare Google-reviews'],
          vig:'ziet_concurrent' },
        { tag:'Sentiment over tijd', h:'Gaat het ergens beter of slechter?',
          p:'Emma bewaart elke maand een meting, zodat je een lijn ziet in plaats van een momentopname. Een concurrent die wegzakt is nieuws; een die stijgt ook.',
          list:['Maandelijkse meting, automatisch','De trend per concurrent','Zichtbaar wanneer er iets kantelt'],
          vig:'ziet_concurrent' },
        { tag:'Positie-update', h:'Waar sta jij in het rijtje?',
          p:'Elke maand zet Emma jouw reviewscore naast die van je concurrenten en laat zien waar je staat. Geen ranglijst om de ranglijst, maar een duiding van wat er verschoof.',
          list:['Jouw plek tussen je concurrenten','Elke maand automatisch bijgewerkt','Met uitleg bij wat er veranderde'],
          vig:'ziet_concurrent' },
      ],
    },
    steps:{ title:'Zo werkt het.', items:[
    ...
    faq:[
      ...
      { q:'Wat zit er allemaal in?', a:'Concurrent-detectie via het KvK-register, de kaart, wekelijkse monitoring, prijsvergelijking per dienst, reviews-analyse per thema, sentiment over tijd en een maandelijkse positie-update. Dat werkt allemaal.' },
