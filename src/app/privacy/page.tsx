        ...
        <div className="legal">
          <div className="legal__content">
            ...
            <ul>
              ...
              <li><b>CookieYes:</b> voor de cookiebanner waarmee je je toestemming beheert. CookieYes verwerkt je toestemmingskeuze en het bijbehorende IP-adres als bewijs van die keuze. CookieYes Limited is gevestigd in het Verenigd Koninkrijk (3 Warren Yard, Warren Park, Wolverton Mill, Milton Keynes MK12 5NW); de doorgifte vindt plaats op basis van het adequaatheidsbesluit van de Europese Commissie voor het Verenigd Koninkrijk, hernieuwd in december 2025. Voor sub-verwerkers hanteert CookieYes een verwerkersovereenkomst met EU-standaardcontractbepalingen.</li>
